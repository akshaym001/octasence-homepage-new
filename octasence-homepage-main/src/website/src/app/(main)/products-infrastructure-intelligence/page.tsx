    ...
    >
      ...
      >
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-white leading-[1.2] tracking-tight mb-10">
            Agentic AI{' '}
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background: hovered
              ? `linear-gradient(90deg, transparent, ${mod.accent}, transparent)`
              : 'transparent',
          }}
        />
      </div>
      ...
      <div className="flex flex-col flex-1 p-6">
        ...
        <div className="flex items-center gap-3 mb-4">
          <div
            className="w-8 h-8 rounded-lg flex items-center justify-center text-white text-xs flex-shrink-0 transition-all duration-300"
            style={{
              background: hovered
                ? `linear-gradient(135deg, ${mod.accent}, ${mod.accent}88)`
        ...
        <h3
          className="text-lg text-white leading-tight mb-3 tracking-tight transition-colors duration-300"
      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        ...
        >
          ...
          <p className="text-white/40 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
            A unified Agentic AI platform for real-time infrastructure
            intelligence. Built for underground, remote, and high-risk
            environments with edge-first intelligence, digital twins, and
...
function HowStep({
  ...
  return (
    ...
    >
      ...
      <div className="pt-1">
        <h4 className="text-lg text-gray-900 mb-2 tracking-tight group-hover:text-[#0000FF] transition-colors duration-300">
          {step.title}
        </h4>
